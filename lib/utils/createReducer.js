...
function createReducer(initialState, handlers) {
  var enforceImmutable = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
  var constructor = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : _immutable2.default.fromJS.bind(_immutable2.default);
